...
<body bgcolor="#7C7574">
	...
	<div class="container_table">
		...
		<div class="table_item"><?php echo ucfirst(strtolower($row["NOMBRE"])) ?></div>
		<div class="table_item"><?php echo ucfirst(strtolower($row["PRECIO"])) ?></div>

		<div class="table_item">
			<a href="eliminar/eliminar_otros.php?id=<?php echo $row["id"] ?>" class="table_item_link">
	...
	<div class="container_add">
		...
		<form action="insertar/insertar_otros.php" method="post" class="container_form">
