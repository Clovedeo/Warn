...
<body bgcolor="#7C7574">
	...
	<div class="container_table">
		...
		<div class="table_item">
			<a href="eliminar/eliminar_prendas.php?id=<?php echo $row["id"] ?>" class="table_item_link">
	...
	<div class="container_add">
		...
		<form action="insertar/insertar_prendas.php" method="post" class="container_form">
			...
			<input class="container_sumbit" type="submit" value="Agregar" required>
