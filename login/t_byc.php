...
<body bgcolor="#7C7574">
	...
	<div align="center" id="header">
		<ul class="menu">
			...
			<li><a href="#">Bolsas y Carteras</a></li>
	...
	<div class="container_table">
		...
		<div class="table_item">
			<a href="eliminar/eliminar_byc.php?id=<?php echo $row["id"] ?>" class="table_item_link">
	...
	<div class="container_add">
		...
		<form action="insertar/insertar_byc.php" method="post" class="container_form">
